  ...
  return (
    <section className="bg-black text-white min-h-screen flex items-center justify-center px-6">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <div className="mb-4">
            <span className="bg-orange-600 text-xs px-3 py-1 rounded-full font-semibold">
          ...
          <p className="mt-6 text-lg text-gray-300 font-medium">
            We’re a web design and development company based in Singapore. Rest
            assured, your website is in good hands with us, from launch through
            to maintenance. You can count on us to deliver a{" "}
        ...
        <div className="flex justify-center items-center relative">
          {/* SVG Devices Illustration with Animation */}
          <svg
            width="300"
            height="300"
            viewBox="0 0 300 300"
            ...
            className="text-orange-500 animate-bounce"  // Added bounce animation
          >
